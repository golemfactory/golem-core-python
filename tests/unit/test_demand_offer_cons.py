...
import pytest
from golem_core.core.props_cons.constraints import Constraint, ConstraintException, ConstraintGroup, Constraints
...
def test_constraints_serialize():
    cons = Constraints([
        ...
        Constraint("list_field", '=', [
            datetime(2023, 1, 2),
            ExampleEnum.FOO,
        ]),
        ConstraintGroup([
            Constraint('some.other.field', '=', 'works!')
        ],
        "|"),
    ])
